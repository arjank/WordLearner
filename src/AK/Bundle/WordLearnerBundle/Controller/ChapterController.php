...
use AK\Bundle\WordLearnerBundle\Form\ChapterType;
...
class ChapterController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AKWordLearnerBundle:Chapter')->findAll();
     ...
     * @Method("POST")
     * @Template("AKWordLearnerBundle:Chapter:new.html.twig")
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AKWordLearnerBundle:Chapter:edit.html.twig")
     */
