...
class BookController extends Controller
{
     ...
     * @Method("POST")
     * @Template("AKWordLearnerBundle:Book:new.html.twig")
     */
    ...
    public function editAction($id)
    {
        ...
        $entity = $em->getRepository('AKWordLearnerBundle:Book')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AKWordLearnerBundle:Book:edit.html.twig")
     */
